...
public class ComputerDAOQueries {
    ...
    public static final String SELECT_WHERE_NAME_CONTAINS_SEQUENCE = "SELECT * FROM " + COMPUTER_TABLE
            + " c where c.name like ?";
    ...
    // public static final String SELECT_ALL_BY_PAGE = "SELECT * FROM " +
    // COMPUTER_TABLE + " LIMIT ? OFFSET ?";
