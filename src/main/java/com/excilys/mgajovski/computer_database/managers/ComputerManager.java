...
//    refresh();
  ...
  public void init() {
    ...
    numberOfRows = 10;
    sequence = "";
    displayedComputers = new ArrayList<>();
...
//    if (computerDAO.findWhereNameContainsSequenceWithPagination(sequence, currentPage, numberOfRows).isPresent()) {
      displayedComputers = computerDAO.findWhereNameContainsSequenceWithPagination(sequence, currentPage, numberOfRows).get();
//    }
  }
  ...
  // mDisplayedComputers = computerDAO.findWithNamedQuery(ComputerDao.NamedQueries.SEARCH,
...
//    refresh();
  ...
  public String toString() {
    /*
     * StringBuilder builder = new StringBuilder(); builder.append("ListManager [mPage=");
     * builder.append(mPage); builder.append(", mSize="); builder.append(mSize);
     * builder.append(", mSearch="); builder.append(mSearch);
     * builder.append(", mDisplayedComputers="); builder.append(mDisplayedComputers);
     * builder.append(", mComputerDao="); builder.append(mComputerDao); builder.append("]"); return
     * builder.toString();
     */
    return null;
  }
