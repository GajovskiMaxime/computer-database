 ...
 * @date 6 mars 2017 This exception is thrown if a DTO field is not correctly fulfilled.
 * @see IdException
 * @see NameException
 * @see DateException
 */
public class DTOMapperException extends Exception {
  ...
  public DTOMapperException(ErrorTags errTag, Throwable error) {
    super(errTag.toString(), error);
  }

  public DTOMapperException(ErrorTags errTag) {
