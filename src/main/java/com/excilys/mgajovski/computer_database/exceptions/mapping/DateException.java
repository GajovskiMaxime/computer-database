 ...
 * @date 3 mars 2017 This exception is thrown if a date is not correctly fulfilled.
...
public class DateException extends DTOMapperException {
  ...
  public DateException(ErrorTags errTag, Throwable error) {
    super(errTag.toString(), error);
  }

  public DateException(ErrorTags errTag) {
